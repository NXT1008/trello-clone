...
const login = async (req, res, next) => {
  try {
     ...
     * Lưu ý thời gian sống của cookie khác với cái thời gian sống của token nhé. Đừng bị nhầm lẫn :D
     */
    // Cookie ở bên userService trả về sau khi login
    res.cookie('accessToken', result.accessToken, {
      httpOnly: true, // Cookie bên Server quản lý,
      secure: true,
      sameSite: 'none', // Cho phép các domain khác nhau có thể giao tiếp,
      maxAge: ms('14 days')
    })
