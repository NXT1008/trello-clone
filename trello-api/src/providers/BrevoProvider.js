...
const sendEmail = async (recipientEmail, customSubject, customHtmlContent) => {
  ...
  // 'to' phải là một Array để sau chúng ta có thể tùy biến gửi 1 email
  //    tới nhiều user tùy tính năng dự án nhé
  ...
  // More info: sendTransacEmail của thư viện nó sẽ return một Promise
