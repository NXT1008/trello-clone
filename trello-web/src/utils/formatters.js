...
// Đây là một kỹ thuật rất hay tận dụng Axios Interceptors và CSS Pointer-events
//  để chỉ phải viết code xử lý một lần cho toàn bộ dự án
// Cách sử dụng: Với tất cả các link hoặc button mà có hành động gọi api thì thêm class
