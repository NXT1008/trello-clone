...
function SidebarCreateBoardModal({ afterCreateNewBoard }) {
  ...
  const submitCreateNewBoard = (data) => {
    ...
    createNewBoardAPI(data).then(() => {
      ...
      // Sau khi tạo mới board thì sẽ gọi props afterCreateNewBoard từ file index.jsx
      // của boardList
      afterCreateNewBoard()
    })
  }

  // <>...</> nó là React Fragment, dùng để bọc các phần tử lại mà không cần chỉ định DOM Node cụ thể nào cả.
  return (
    <>
