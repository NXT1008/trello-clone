...
function LoginForm() {
  ...
  // use useSearchParams() to get params from URL
  // param lấy từ bên AccountVerification.jsx và RegisterForm.jsx truyền qua
          ...
          <Box sx={{ padding: '0 1em 1em 1em' }}>
            <Box sx={{ marginTop: '1em' }}>
              <TextField
                ...
                variant="outlined"
                error={!!errors['email']}
                // Đăng ký việc validate dữ liệu với name là email, rule do chúng ta định nghĩa
                {...register('email', {
