...
function Notifications() {
  ...
  const handleClickNotificationIcon = (event) => {
    ...
    // Khi click vào icon quả chuông thông báo thì set lại trạng thái của biến newNotification về false
  ...
  // Fetch danh sách các lời mời inviations
  const dispatch = useDispatch()
  useEffect(() => {
    dispatch(fetchInvitationsAPI())

    // Tạo một func xử lý khi nhận được sự kiện real-time, docs hướng dẫn:
    // https://socket.io/how-to/use-with-react
    const onReceiveNewInvitation = (inviation) => {
      // Nếu thằng user đang đăng nhập hiện tại mà chúng ta lưu trong redux chính là
      //  thằng invitee trong bản ghi invitation
      if (inviation.inviteeId === currentUser._id) {
        // Bước 01: Thêm bản ghi Invitation mới vào trong redux
        dispatch(addNotification(inviation))
  ...
  // Cập nhật trạng thái - status của một cái lời mời john Board
