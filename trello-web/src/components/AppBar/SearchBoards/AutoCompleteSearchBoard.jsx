...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    // Dùng createSearchParams của react-router-dom để tạo một cái searchPath chuẩn với q[title] để gọi lên API (nếu search cùng lúc nhiều trường thì sẽ truyền thêm, ở đây chỉ search theo title)
    ...
    fetchBoardsAPI(searchPath)
      ...
      .finally(() => {
        // Lưu ý về việc setLoading về false luôn phải chạy trong finally để dù có lỗi hay không cũng không hiện loading nữa
        setLoading(false)
      })
  }
