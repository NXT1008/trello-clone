...
const markdownValueExample = `
  ...
  **Hello world | XuanTheDev - A Developer! | Trello MERN Stack Advanced**
  [![](https://avatars.githubusercontent.com/u/116452075?v=4&s=80)](https://avatars.githubusercontent.com/u/116452075?v=4)
  \`\`\`javascript
...
function CardDescriptionMdEditor({ cardDescriptionProp, handleUpdateCardDescription }) {
  ...
  const updateCardDescription = () => {
    ...
    // Gọi lên component cha để tiến hành cập nhật
