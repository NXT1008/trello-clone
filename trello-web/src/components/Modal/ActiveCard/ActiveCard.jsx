...
function ActiveCard() {
  ...
  // Không dùng biến State để check đóng mở modal nữa vì chúng ta check theo biến isShowModalActiveCard lưu trong redux
  ...
  return (
    <Modal
      disableScrollLock
      open={isShowModalActiveCard} // Đóng mở theo biến isShowModalActiveCard trong redux
          ...
          <Grid xs={12} sm={9}>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <CardActivitySection
                ...
                handleAddCardCommentProps={onAddCardComment}
              />
            </Box>
          </Grid>
