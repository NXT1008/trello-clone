...
function CardActivitySection({ cardComments=[], handleAddCardCommentProps }) {
  ...
  const handleAddCardComment = (event) => {
    ...
    if (event.key === 'Enter' && !event.shiftKey) {
      ...
      // Gọi lên Props Function của component cha
      handleAddCardCommentProps(commentToAdd).then(() => {
        event.target.value = ''
      })
    }
  }
